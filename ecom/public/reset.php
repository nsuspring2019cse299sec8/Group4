	...
	<div class="row">
		<div class="col-lg-6 col-lg-offset-3">
            ...
            <?php validation_code(); ?>  <!-- checking the validation code function -->
						<?php password_reset(); ?> 	 <!-- reset password function -->
		</div>
	</div>
										...
										<div class="form-group">
											<div class="row">
												<div class="col-sm-6 col-sm-offset-3">
													...
													<a href="index.php">
															<input type="button" name="reset-password-submit" id="reset-password-submit" tabindex="4" class="form-control btn btn-danger" value="Cancel" />
													</a>
